...
def get_data(driver, url):
    title=driver.find_element_by_xpath('//h1[@data-automation-id="title"]').text
    year=driver.find_element_by_xpath('//span[@data-automation-id="release-year-badge"]').text
    duration=driver.find_element_by_xpath('//span[@data-automation-id="runtime-badge"]').text
...
def get_subtitle_data(driver,url):
    ...
    driver.find_element_by_link_text("Continue watching").click()
...
if __name__=="__main__":
    url='https://www.primevideo.com/region/eu/detail/0IIISZ9GJ0XQ718NNWIRPRCTE7'
